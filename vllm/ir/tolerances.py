...
if hasattr(torch, "float4_e2m1fn_x2"):
    ...
    # Guarded: this dtype doesn't exist before a certain torch release, and
    # this module is otherwise imported unconditionally (see the module's
    # callers), so referencing it as a dict key must not be a hard
    # requirement on torch version.
